  ...
  <div class="login-page">
    <div class="form">
      <div class="alert alert-success">
        <strong>We have sent an OTP to your email</strong>
      </div>
      ...
      <form @submit.prevent="resetPassword" method="post" class="login-form">
        <input type="text" placeholder="OTP" v-model="form.token" />
        ...
        axios
          ...
          .catch((error) => {
            ...
            if (error.response.status == 400) {
              ...
              console.log(error.response.data.error.name[0]);
            }
          });
      }
    },
